...
public class BikeDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(BikeDetails.this,Description.class);
                startActivity(intent);
            }
    ...
    private void insertData() {
        ...
        FirebaseDatabase.getInstance().getReference().child("bike_details").push()
                .setValue(map)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void unused) {
                        new SweetAlertDialog(BikeDetails.this,SweetAlertDialog.SUCCESS_TYPE)
                                ...
                                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                    ...
                                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                                        Intent intent = new Intent(BikeDetails.this,MakeBooking.class);
                                        startActivity(intent);
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(Exception e) {
                        new SweetAlertDialog(BikeDetails.this,SweetAlertDialog.ERROR_TYPE)
                                .setTitleText("Message")
                                ...
                                .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                    @Override
                                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                                        Intent intent = new Intent(BikeDetails.this,BikeDetails.class);
                                        startActivity(intent);
